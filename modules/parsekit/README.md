...
```bash
python -m pip install "parsekit @ git+https://github.com/sakino-shiisawa/py-toolbox.git@main#subdirectory=modules/parsekit" --target ./script/modules --no-deps --upgrade
```
